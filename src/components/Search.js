...
const Search = ({searchTerm , settingQuery, modalStateApp }) => {
  ...
  return (
    <>
      <nav className={(modalStateApp===true?'z-30':'z-50') + " drop-shadow-lg z-30 sticky top-0 flex items-center flex-wrap justify-between px-20 bg-slate-700 p-6 transition-all ease-out duration-300 " + (scrollPosition>10?' pt-2 h-30 px-5' : '')}>
