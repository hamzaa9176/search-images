...
const Search = ({searchTerm , settingQuery, modalStateApp }) => {
  ...
  return (
    <>
      <nav className={"drop-shadow-lg sticky top-0 flex items-center flex-wrap justify-between px-20 bg-slate-700 p-6 transition-all ease-out duration-300 " + (modalStateApp?'z-20':'z-40') + (scrollPosition>10?' pt-2 h-30 px-5' : '')}>
